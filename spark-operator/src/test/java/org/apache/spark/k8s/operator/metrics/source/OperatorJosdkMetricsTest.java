...
class OperatorJosdkMetricsTest {
  ...
  void testTimeControllerExecution() throws Exception {
    ...
    Assertions.assertTrue(
        metrics.containsKey("sparkapplication.testns.sparkappreconciler.reconcile.both"));
    Assertions.assertTrue(
        metrics.containsKey("sparkapplication.sparkappreconciler.reconcile.success.both"));
    Assertions.assertTrue(
        metrics.containsKey("sparkapplication.testns.sparkappreconciler.reconcile.success.both"));
    ...
    try {
      ...
      Assertions.assertTrue(
          metrics.containsKey("sparkapplication.sparkappreconciler.reconcile.failure"));
      Assertions.assertTrue(
          metrics.containsKey(
              "sparkapplication.sparkappreconciler.reconcile.failure.exception"
                  + ".nosuchfieldexception"));
      Assertions.assertTrue(
          metrics.containsKey("sparkapplication.testns.sparkappreconciler.reconcile.failure"));
      Assertions.assertTrue(
          metrics.containsKey(
