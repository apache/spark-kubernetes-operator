...
import static org.apache.spark.k8s.operator.config.SparkOperatorConf.OperatorProbePort;
...
public class ProbeService {
  ...
  public ProbeService(
    ...
    try {
      this.server = HttpServer.create(new InetSocketAddress(OperatorProbePort.getValue()), 0);
    } catch (IOException e) {
