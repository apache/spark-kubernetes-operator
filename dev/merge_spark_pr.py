...
GITHUB_API_BASE = "https://api.github.com/repos/apache/spark-kubernetes-operator"
...
def initialize_jira():
    ...
    if not JIRA_IMPORTED:
        ...
        asf_jira = jira.client.JIRA(jira_server, basic_auth=(JIRA_USERNAME, JIRA_PASSWORD), timeout=(3.05, 30))
    else:
