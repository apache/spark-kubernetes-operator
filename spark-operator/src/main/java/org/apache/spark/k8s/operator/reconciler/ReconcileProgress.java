...
import static org.apache.spark.k8s.operator.config.SparkOperatorConf.SparkAppReconcileIntervalSeconds;
...
public class ReconcileProgress {
  ...
  public static ReconcileProgress proceed() {
    return new ReconcileProgress(
        false, true, Duration.ofSeconds(SparkAppReconcileIntervalSeconds.getValue()));
  }

  public static ReconcileProgress completeAndDefaultRequeue() {
    return new ReconcileProgress(
        true, true, Duration.ofSeconds(SparkAppReconcileIntervalSeconds.getValue()));
  }
