...
package org.apache.spark.k8s.operator.controller;

import static org.apache.spark.k8s.operator.reconciler.SparkReconcilerUtils.driverLabels;
import static org.apache.spark.k8s.operator.reconciler.SparkReconcilerUtils.executorLabels;
...
/**
 * Context for {@link org.apache.spark.k8s.operator.SparkApplication} resource Includes secondary
    ...
    synchronized (this) {
      if (secondaryResourceSpec == null) {
        secondaryResourceSpec =
            SparkAppReconcileUtils.buildResourceSpec(
