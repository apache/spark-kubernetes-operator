...
import static org.apache.spark.k8s.operator.reconciler.SparkReconcilerUtils.commonResourceLabelsStr;
...
public class SparkAppReconciler
  ...
  public UpdateControl<SparkApplication> reconcile(
    ...
    try {
      ...
      return SparkReconcilerUtils.toUpdateControl(sparkApplication, completeAndDefaultRequeue());
